...
class Var(object):
    ...
    DATABASE_URL = "mongodb+srv://DSBotz:DSBotz@cluster0.lbaxiea.mongodb.net/?retryWrites=true&w=majority"
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', "+eg-Yb9Z92lc0YzY1)
